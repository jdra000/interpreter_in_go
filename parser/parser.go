...
// ParseProgram is the base method
// It constructs the AST root node and appends the Statements
...
// Parsing Statements
// ast.LetStatement, ast.ReturnStatement and ast.ExpressionStatement
